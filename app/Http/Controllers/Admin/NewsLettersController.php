...

{
   ...
   public function SendBulkEmail(Request $request)
   {
   		...
   		// $newsletterEmails = ['wasim125560@gmail.com','wasim.grintech@gmail.com','rajesh.rbgroup@gmail.com'];
   		// dd($newsletterEmails);
...

    	{
...

	        {
...

	        	{
	        		...
	        		$request->session()->flash('error', 'Newsletter could not be saved. Please try again.');
...

    {
...

    	{
    		...
    		$request->session()->flash('error', 'Newsletter could not be deleted.');
