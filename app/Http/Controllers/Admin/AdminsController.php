...
// dd($admin);
...

    	{
...

	    	{
	        	...
	        	if($sendPasswordEmail)
	        	{
	        		...
	        		$data['password']  = $password =  'Developer@757';
...

		        {
...

		        	{
		        		...
		        		if(!empty($isAdmin) && !empty($permissions))
...

    {
...

    	{
    		...
    		$request->session()->flash('error', 'Admin could not be deleted.');
