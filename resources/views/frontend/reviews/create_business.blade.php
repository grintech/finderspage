            ...
            <div class="col-lg-11 d-flex justify-content-between align-items-start">
                <div class="flex-grow-1">
                    <p class="fw-bold lead mb-0">
                        <strong>{{ $user->first_name ?? 'Anonymous' }}</strong>
                    </p>
							...
							<div class="row mb-3">
								<div class="col-lg-2">
									@if (UserAuth::getLoginId())
										<img src="{{ asset($user->image ? 'assets/images/profile/' . $user->image : 'user_dashboard/img/undraw_profile.svg') }}" class="rounded-circle img-fluid shadow-1" alt="user avatar" width="50" height="50" />
									@else
