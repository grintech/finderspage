...
<section class="job-listing">
    ...
    <div class="container">
        <div class="row">
            <h1 class="text-center" style="font-size: 2.0rem;">Business</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 coll-1 mb-2">
                                <div class="select-job">
                                    <input class="form-control main-cat" id="searcjob" type="text" name="Business" value="Business" readonly>
                                </div>
                            </div>
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-6 col-6 columnJoblistig mb-3">
                                        <div class="feature-box">
                                        	<span class="onsale">Featured!</span>
                                             <a href="{{route('business_page.front.single.listing', $Records->slug)}}">   
                                            <div id="demo-new" class="">
                                                <!-- Indicators/dots -->
                                                <!-- The slideshow/carousel -->
                                                <div class="carousel-inner">
                                                    <?php
                                                        $itemFeaturedImages = trim($Records->business_logo,'[""]');
                                                        ...
                                                        if(is_array($itemFeaturedImage)) {
                                                            foreach($itemFeaturedImage as $keyitemFeaturedImage => $valueitemFeaturedImage) { if($keyitemFeaturedImage == 0) {$class='active'; } else { $class='in-active'; } ?>
                                                                    <div class="carousel-item <?= $class; ?>">
                                                                        <img src="{{asset('business_img')}}/{{ $valueitemFeaturedImage }}" alt="Los Angeles" class="d-block w-100" onerror="this.onerror=null; this.src=\'' . asset('images_blog_img/1688636936.jpg') . '\'">
                                                                    </div>
                                                            <?php }     
                                                        }
                                                    ?>
                                                         ...
                                                         <ul class="list-unstyled" style="margin-bottom: 0px;">
                                                            <li class="userIcon" style="display: flex;">
                                                                ...
                                                                <div class="comments-area" bis_skin_checked="1">
                                                                  <h6>{{$user->username}}</h6>
                                                                   <p class="job-title"><b>{{ ucfirst($Records->business_name) }}</b></p>
                                                                </div>
                                                            </li>
                                                        </ul>
                                                    @endif
                                                @endforeach --}}
                                                <p class="job-title">{{ ucfirst($Records->business_name) }}</p>
