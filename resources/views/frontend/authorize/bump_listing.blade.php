               ...
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     <div class="row" id="new_css">
                           <div class="col-lg-6">
                              <div class='form-row'>
                                 <input type="radio" name="planprice" value="3" class="radioBtnClass " checked="checked">
                                 <label>Bump Post Price</label>
                                 <span class="showprice"> &nbsp;$4.98/day </span>
                              </div>
                           </div>
                        </div>
                  <form role="form" action="{{ route('pay.auth.save',$post_id) }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="" id="payment-form">
                        @csrf
                        <input type="hidden" name="planprice" value="{{$post_price}}" >
                        <div id="loader" style="display:none">
                           <!-- You can use any loader icon or animation here -->
                            <img src="{{asset('user_dashboard/img/payment-animation.gif')}}" alt="" class="processing-img" >
