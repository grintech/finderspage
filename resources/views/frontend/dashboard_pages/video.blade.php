  ...
  <div class="container">
    <div class="row jutify-content-center">
      <div class="col-lg-8 col-md-8 col-sm-6 mx-auto">
        <form method="post" action="{{route('save.video')}}" enctype="multipart/form-data">
          @csrf
          <span>
          ...
          <div class="card">
            <div class="card-header">
              <div class="d-flex justify-content-between">
                ...
                <!-- <button type="submit" id="save_button" class="btn btn-primary save-btn ms-auto">Publish</button> -->
              </div>
            </div>
          </div>
          <div class="card">
          ...
          <div class="card border-left-warning shadow mt-3">
            <div class="card-body py-2">
              <div class="caption-area">
                <label> Music</label>
                <input type="text" class="form-control" name="title" id="caption" placeholder="Music" >
              </div>
            </div>
            ...
            <div class="card border-left-warning shadow">
              <div class="card-head" id="headingOne">
                <div class="mb-0 text-black head" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                  <span class="left-icon"><i class="bi bi-justify-left"></i> Add Description (Max limit 400 words, and add up to 30 hashtags) </span>
                  <span class="arrow">
              ...
              <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#description">
                <div class="card-body pt-1">
                  ...
                  <textarea class="form-control desc" name="description" id="desc" placeholder="Add description, hashtags, and more ..."></textarea>
          ...
          <!--   <div class="card border-left-warning shadow mt-3">
                    <div class="card-body py-2">
                        <div class="caption-area">
                            <input type="text" readonly class="form-control" name="title" id="music" placeholder="Add music">
                            <ul>
                            <li class="simp-active"> <span class="play-icon videoplayicons"><img src="https://finderspage.com/public/assets/img/play.png" height="33px" alt="play" /></span><span class="simp-source" data-src="https://www.dropbox.com/s/k011ag91uktonbv/Angklung%20Preman%20Pensiun.mp3?dl=1">Angklung Preman Pensiun</span></li>
                            </ul>
                        </div>
                    </div>
                </div> -->
          ...
          <div class="accordion mt-3" id="mension">
            <div class="card border-left-warning shadow">
              ...
              <div id="mension-user" class="collapse" aria-labelledby="headingOne" data-parent="#mension">
                <div class="card-body pt-1">
                  <textarea class="form-control" name="mension" id="mension_user" placeholder="Type username to get user list "></textarea>
            ...
            <div class="card border-left-warning shadow">
              ...
              <div id="collapsethree" class="collapse" aria-labelledby="headingthree" data-parent="#comment_visibility">
                <div class="card-body pt-1">
                  <label class="custom-toggle d-flex justify-content-between">
                    <span>Public</span>
                    <input type="checkbox" name="comment_view_as" value="public" checked>
                  </label>
                  <hr>
                  <label class="custom-toggle d-flex justify-content-between">
                    <span>Private</span>
                    <input type="checkbox" name="comment_view_as" value="private">
                  </label>
                </div>
              </div>
            </div>
          ...
          <div class="accordion mt-3" id="location">
            <div class="card border-left-warning shadow loca-tion">
              <div class="card-head" id="headingThree">
                <div class="mb-0 text-black head" data-toggle="collapse" data-target="#collapseThree" aria-expanded="true" aria-controls="collapseThree">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#location">
                <div class="card-body pt-1">
                  <div class="location-field">
                    <input type="text" class="form-control get_loc" name="location" id="location" placeholder="Location">
                  </div>
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#video-type">
                  <div class="card-body pt-1">
                    ...
                    <label class="custom-toggle d-flex justify-content-between" data-toggle="tooltip" data-placement="top" title="Regular Video">
                      ...
                      <input type="radio" name="post_type" value="Normal Post" checked required>
                    </label>
                    @error('post_type')
                        <small class="text-danger">{{ $message }}</small>
                    @enderror
            ...
            <div class="card">
              <div class="card-header">
                <div class="text-center">
                  <!-- <h4 class="h3 mb-0 text-gray-800 fw-bold detail-head">Videos & Films</h4> -->
                  <button type="submit" id="save_button" class="btn btn-primary save-btn ms-auto text">Publish</button>
                </div>
              </div>
            </div>
        </form>
...
<script>
  ...
  $(document).ready(function() {
    ...
    $('#mension_user').on('input', function() {
      var text = $(this).val();
      var usernames = text.split(/[ ,]+/); // Split by space or comma
      console.log(usernames);

      // Reset selected users if no usernames are provided
      if (usernames.length === 1 && usernames[0].trim() === '') {
        selectedUsers = [];
        updateTextbox();
      }

      // Fetch user list for each username
      for (var i = 0; i < usernames.length; i++) {
        var username = usernames[i];
        if (username.trim() !== '' && !selectedUsers.includes(username)) {
    ...
    function fetchUserList(username) {
      var csrfToken = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
      $.ajax({
        url: "{{ route('getfollower') }}", // Use Laravel route function
        method: 'POST',
        headers: {
          'X-CSRF-TOKEN': csrfToken
        },
...
<script>
    ...
    //     // Trim the input if it exceeds the maximum number of words
    //     var inputWords = $(this).val().trim().split(/\s+/);
    //     var trimmedWords = inputWords.slice(0, maxWords);
