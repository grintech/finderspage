...
@section('content')
    ...
    <div class="main_title black_title">
        <h3>Create a Free Post max321</h3>
    ...
    <section class="form_section">
        <form method="post" action="<?php echo route('post.create'); ?>" class="form-validation">
            ...
            <div class="card">
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" type="text" name="event_start_date" placeholder=""
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control timepicker" type="text" name="event_start_time" placeholder=""
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control datepicker" type="text" name="event_end_date" placeholder=""
                        ...
                        <div class="col-xs-12 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control timepicker" type="text" name="event_end_time" placeholder=""
                ...
                <div class="form-group realstate_cate">
                    <label class="form-check-label" for="exampleInput">Property Video</label><br>
