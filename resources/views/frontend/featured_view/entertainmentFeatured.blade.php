...
<section class="job-listing">
    ...
    <div class="container">
        <div class="row">
            <h1 class="text-center" style="font-size: 25px;"> Entertainment Industry Jobs </h1>
                                ...
                                @foreach($entertainment as $Records)
                                    ...
                                    <div class="col-lg-3 col-md-6 col-sm-12 col-12 columnJoblistig mb-3">
                                            <div class="feature-box">
                                             ...
                                             <a href="{{route('Entertainment.single.listing',$Records->id)}}">   
                                                        ...
                                                        if(is_array($itemFeaturedImage)) {
                                                            foreach($itemFeaturedImage as $keyitemFeaturedImage => $valueitemFeaturedImage) { if($keyitemFeaturedImage == 0) {$class='active'; } else { $class='in-active'; } ?>
                                                                    <div class="carousel-item <?= $class; ?>">
                                                                        <img src="{{ asset('images_entrtainment/' . $valueitemFeaturedImage) }}" 
                                                                         alt="Los Angeles" 
                                                                         class="d-block w-100" 
