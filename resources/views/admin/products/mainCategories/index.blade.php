			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						<?php if(Permissions::hasPermission('main_categories', 'create')): ?>
						<a href="<?php echo route('admin.products.mainCategories.add') ?>" class="btn btn-neutral">New</a>
						<?php endif;?>
						@include('admin.products.mainCategories.filters')
					</div>
				</div>
			</div>
		</div>
				...
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						...
						<div class="actions">
							...
							<?php if(Permissions::hasPermission('main_categories', 'delete')): ?>
							<div class="dropdown" data-toggle="tooltip" data-title="Bulk Actions" >
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		                            <a 
		                            	...
		                            	onclick="bulk_actions('<?php echo route('admin.products.mainCategories.bulkActions', ['action' => 'delete']) ?>', 'delete');">
						...
						<table class="table align-items-center table-flush listing-table">
							...
							<tbody class="list">
								<?php if(!empty($listing->items())): ?>
									@include('admin.products.mainCategories.listingLoop')
								<?php else: ?>
