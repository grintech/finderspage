            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               ...
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('stripe.bump.entertainment.save') }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="{{$public_key}}" id="payment-form">
                        @csrf
