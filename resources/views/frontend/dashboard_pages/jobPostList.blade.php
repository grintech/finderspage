      ...
      <div class="container">
        <div class="row justify-content-end">
          <div class="col-lg-12">
            ...
            <h3 class="d-inline"><b>Your Job Ads</b></h3>
            <a class="btn profile-button float-right mb-2" href="{{route('post.create')}}">Add</a>
                    ...
                    <table class="table">
                      ...
                      @if($userData->subscribedPlan != '7-day-14' && $userData->subscribedPlan != '1-month-55' && !empty($userData->subscribedPlan ))
                        ...
                        @if($currentDateTime <= $nextTenDays)
                          <a href="{{route('job_edit',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit">
                      ...
                      @else 
                        <a href="{{route('job_edit',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit"></i></a>
                      ...
                      @endif
                           ...
                           @if($blogs->bumpPost=="1")
                            ...
                            @else
                              <a href="{{route('pay.auth',General::encrypt($blogs->id))}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="$4.98 to bump this listing">Bump</i></a>
                           @endif
