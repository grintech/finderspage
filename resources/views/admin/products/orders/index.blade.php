			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 text-white d-inline-block mb-0">Manage Product Orders</h6>
					</div>
					<div class="col-lg-6 col-5 text-right">
						@include('admin.products.orders.filters')
					</div>
				</div>
			</div>
		</div>
			...
			<div class="col">
				...
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Product Orders!</h3>
						</div>
						<div class="actions">
							...
							<div class="dropdown" data-toggle="tooltip" data-title="Bulk Actions" >
								...
								<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		                            <a 
		                            	...
		                            	onclick="bulk_actions('<?php echo route('admin.products.orders.bulkActions', ['action' => 'delete']) ?>', 'delete');">
						...
						<table class="table align-items-center table-flush listing-table">
							...
							<tbody class="list">
								<?php if(!empty($listing->items())): ?>
									@include('admin.products.orders.listingLoop')
								<?php else: ?>
