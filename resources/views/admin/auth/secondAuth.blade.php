...
@section('content')
	...
	<div class="container mt-2 pb-5 py-7 py-lg-7 pt-lg-8">
			...
			<div class="col-lg-5 col-md-7">
				...
				<div class="card bg-transparent border-0 mb-0">
					...
					<div class="card-header bg-transparent pb-3 text-center mt-5">
						<h1 class="text-dark head py-3">Second Factor Authentication?</h1>

						<div class="text-center mt-2 mb-3"><h2 class="text-dark">Enter one time password to login.</h2></div>

					</div>

					<div class="card-body bg-white n-shadow px-lg-5 py-lg-5">
