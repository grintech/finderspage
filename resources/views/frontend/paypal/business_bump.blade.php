                  ...
                  <div class="panel-body">
                     ...
                     <div class="row text-center" id="new_css">
                        ...
                        <div class="col-lg-12 text-center">
                          <form role="form" action="{{ route('pay.business.bump',$post_id) }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="" id="payment-form">
                        @csrf
  ...
  paypal.Buttons({
    ...
    onApprove: function(data, actions) {
      return actions.order.capture().then(function(details) {
        ...
        $.ajax({
          url: '/payment-checkout-all-business', // Replace with your route
          method: 'POST',
          data: {
            post_id: post_id,
