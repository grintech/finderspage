...
<section class="job-listing">
    ...
    <div class="container">
        <div class="row">
            <h1 class="text-center" style="font-size: 2.0rem;">Fundraiser listing</h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 coll-1 mb-2">
                                <div class="select-job">
                                    <input type="text" name="Fundraisers" value="Fundraisers" id="searcjob" class="form-control main-cat">
                                </div>
                            </div>
