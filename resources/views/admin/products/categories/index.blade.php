						...
						<table class="table align-items-center table-flush listing-table">
							<thead class="thead-light">
								<tr>
									...
									<th class="sort">
										Main Category
										<?php if(isset($_GET['sort']) && $_GET['sort'] == 'product_categories.title' && isset($_GET['direction']) && $_GET['direction'] == 'asc'): ?>
										<i class="fas fa-sort-down active" data-field="product_categories.title" data-sort="asc"></i>
										<?php elseif(isset($_GET['sort']) && $_GET['sort'] == 'product_categories.title' && isset($_GET['direction']) && $_GET['direction'] == 'desc'): ?>
										<i class="fas fa-sort-up active" data-field="product_categories.title" data-sort="desc"></i>
										<?php else: ?>
