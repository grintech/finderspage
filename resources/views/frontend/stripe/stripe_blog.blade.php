      ...
      <div class="card p-3">
         <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               <h1 class="strip-heading">Select your Plan to Make a Bump Post</h1>
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('stripe.bump.blog') }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="{{$public_key}}" id="payment-form">
                        @csrf
                        ...
                        <div class='form-row ' id="ErrorDiv">
