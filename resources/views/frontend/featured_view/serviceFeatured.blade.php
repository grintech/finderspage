                            ...
                            <div class="col-md-12 coll-1 mb-2">
                                <div class="select-job">
                                    <select id="searcjob" class="form-select" name="searcjobParent">
                                        ...
                                        <option value="705" selected>Services</option>
                                    </select>
                                </div>
                            </div>
                                            ...
                                            if (empty($itemFeaturedImages)) {
                                                ...
                                                if (is_array($itemFeaturedImage)) {
                                                    foreach ($itemFeaturedImage as $keyitemFeaturedImage => $valueitemFeaturedImage) {
                                                        ...
                                                        echo "<img src='" . asset('images_blog_img/' . $valueitemFeaturedImage) . "' alt='Image' class='d-block w-100'>";
                                                        echo "</div>";
                                                    }
                                                }
                                            }
