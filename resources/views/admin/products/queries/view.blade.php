			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 text-white d-inline-block mb-0">Manage Queries</h6>
					</div>
					<div class="col-lg-6 col-5 text-right">
						<a href="<?php echo route('admin.products.queries') ?>" class="btn btn-neutral"><i class="fa fa-angle-left"></i> Back</a>
						<div class="dropdown" data-toggle="tooltip" data-title="More Actions">
							...
							<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
								...
								<a 
									...
									href="javascript:;"
									data-link="<?php echo route('admin.products.queries.delete', ['id' => $page->id]) ?>"
								>
				...
				<div class="card">
					...
					<div class="card-header">
						<div class="row align-items-center">
							<div class="col-8">
								<h3 class="mb-0">Queries Information</h3>
							</div>
						</div>
					</div>
