      ...
      <div class="container">
        <div class="row justify-content-end">
          <div class="col-lg-12">
            ...
            <h3 class="d-inline"><b>Your Shopping Ads</b></h3>
            <a class="btn profile-button float-right mb-2" href="{{route('shopping')}}">Add</a>
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-4 col-md-6 mb-4 job-post-listing">
            ...
            @endif
              <div class="card-body">
                <div class="pic">
                  @if (isset($blogs->featured_image))
                      <img src="{{ asset('images_blog_img/' . $blogs->featured_image) }}" alt="Los Angeles" class="img-fluid d-block w-100" onerror="this.onerror=null; this.src='https://finderspage.com/public/images_blog_img/1688636936.jpg';">
                  @else
                      <?php
                      ...
                      <tbody>
                        ...
                        <tr class="action-list">
                          ...
                          <td colspan="2" class="btn-list">
                            <a href="{{route('shopping_post_single',$blogs->slug)}}" class="btn my-1" data-toggle="tooltip" data-placement="top" title="View"><i class="fa fa-eye" aria-hidden="true"></i></a>
                            ...
                            @if($userData->subscribedPlan != '7-day-14' && $userData->subscribedPlan != '1-month-55' && !empty($userData->subscribedPlan ))
                              ...
                              @if($currentDateTime <= $nextTenDays)
                                <a href="{{route('shoppingEdit',$blogs->slug)}}" class="btn btn-warning my-1" data-toggle="tooltip" data-placement="top" title="Edit">
                            ...
                            @else
                             ...
                             <a href="{{route('shoppingEdit',$blogs->slug)}}" class="btn btn-warning my-1"><i class="far fa-edit"></i></a> 
                             
                            @endif

                           

                            <a id="blog_delete" delete-link="{{route('delete_services',$blogs->id)}}" href="#" class="btn btn-red my-1" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                            @if($blogs->bumpPost=="1")
                            ...
                            @else
                            <a href="{{route('pay.auth',General::encrypt($blogs->id))}}" class="btn btn-primary my-1" data-toggle="tooltip" data-placement="top" title="$5.08 to bump this listing">Bump</i></a>
                            @endif
        ...
        var link = $(this).attr("delete-link");
         Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
				      'Deleted!',
				      'Your Shopping listing has been deleted.',
				      'success'
				    )
            }
        });
