...
?>
@if($fundraiserFeaturedPost->isNotEmpty())
<h4 class="text-center pb-1">Fundraisers</h4>
    <div class="container">
        <div class="row">
            @foreach($fundraiserFeaturedPost as $feature)
              <div class="col-lg-2 col-md-4 col-sm-12 col-12">
                <div class="element element-1">
                    <div class="feature-box">
                        <span class="onsale">Featured!</span>
                        <?php $useid = UserAuth::getLoginId();?>
                        <a href="{{route('single.fundraisers',$feature->slug)}}">  
                            ...
                            <div class="button-sell" style="margin-top: 0px;">
                                <span><a href="{{route('fundraiserViewAll',$feature->slug)}}" class="btn create-post-button" data-product-id="{{$feature->id}}">View details</a></span>
                            </div>
                        </a>
                    </div>
                </div>
            ...
            <div class="col-lg-12 text-center" bis_skin_checked="1">
                <a href="{{route('fundraiserViewAll')}}" class="btn fields-search">View All</a>
            </div>
        </div>
    </div>
    @endif
