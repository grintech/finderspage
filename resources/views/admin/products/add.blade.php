					...
					<form method="post" action="<?php echo route('admin.products.add') ?>" class="form-validation">
						...
						<div class="pl-lg-4">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" name="sample_no" placeholder="Sample Number" value="{{ old('sample_no') }}">
								@error('sample_no')
								    <small class="text-danger">{{ $message }}</small>
								@enderror
							</div>
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="form-group">
										...
										<textarea class="form-control" placeholder="Small Description" name="small_description" maxlength="95">{{ old('small_description') }}</textarea>
