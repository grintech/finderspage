			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					<div class="col-lg-6 col-7">
						<h6 class="h2 text-white d-inline-block mb-0">Manage Product Sub Categories</h6>
					</div>
					<div class="col-lg-6 col-5 text-right">
						<?php if(Permissions::hasPermission('product_categories', 'create')): ?>
						<a href="<?php echo route('admin.products.subCategories.add') ?>" class="btn btn-neutral">New</a>
						<?php endif;?>
...
<!--!!!!! DO NOT REMOVE listing-block CLASS. INCLUDE THIS IN PARENT DIV OF TABLE ON LISTING PAGES !!!!!-->
				<div class="card listing-block">
					...
					<div class="card-header border-0">
						<div class="heading">
							<h3 class="mb-0">Here Is Your Product Sub Categories!</h3>
						</div>
						<div class="actions">
