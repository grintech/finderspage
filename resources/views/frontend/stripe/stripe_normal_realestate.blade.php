      ...
      <div class="card p-3">
         <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               <h1 class="strip-heading">Realestate listings are charged $3. Your listing will expire after 30 days. If you renew it before the 30 days is up, your listing will stay up for another 30 days.</h1>
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('stripe.normal-realestate.save') }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="{{$public_key}}" id="payment-form">
                        @csrf
                        <div class="row" id="new_css">
                           <div class="col-lg-12">
                              <div class='form-row'>
                                 <input type="radio" name="planprice" value="3-Normal-listing" class="radioBtnClass " checked="checked">
                                 <label>Normal listing Price</label>&nbsp;
                                 <span class="showprice"> $3/Per listing </span>
                              </div>
                           </div>
                        </div>
