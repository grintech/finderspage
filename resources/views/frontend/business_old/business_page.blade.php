...
<section class="profile-view" style="display:none;">
    @include('admin.partials.flash_messages')
    <div class="profle_tag">
        @if($user->image)
        <img src="{{url('/assets/images/profile')}}/{{$user->image}}" style="width: 100px;" alt="Image">
        @else
        <img src="https://finderspage.com/new-web/public/front/images/dummy-user.jpg" style="width: 100px;" alt="Image">
        @endif
        ...
        <div class="pond">
            ...
            @if($user->role == 'individual' && UserAuth::getLoginId() == $user->id)
            <div style="padding-top: 10px;">
                <a href="{{url('/edit-user-profile')}}/<?php echo General::encrypt(UserAuth::getLoginId()) ?>" style="margin-top:20px;">Edit Profile</a>
            </div>
            @endif
        </div>
    </div>
...
<section class="business_banner" style="background:#F5F5F5;">
    <div class="container">
