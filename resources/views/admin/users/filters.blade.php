{{-- <a 
	...
	onclick="$('#exportRecords input[name=type][value=all]').prop('checked', true).change(); $('#export').modal('show');"
>
		<i class="fas fa-file-export text-primary"></i>
		<span class="status">Export Records</span>
</a> --}}
<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="{{url()->current()}}" id="filters-form">
			...
			<div class="dropdown-divider"></div>
			<a href="{{url()->current()}}" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
