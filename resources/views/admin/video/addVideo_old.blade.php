...
<div class="container-fluid px-5">
	<form method="post" action="{{route('video.save')}}" class="form-validation" enctype="multipart/form-data" id="job_form">
 					{{ @csrf_field() }}
                    <!-- Page Heading -->
                    <div class="d-sm-flex flex-column  mb-3">
                        <h1 class="h3 mb-0 text-gray-800 fw-bold">Create a Video</h1>
                    ...
                    <div class="row bg-white border-radius pb-4 p-3">
                       ...
                       <div class="col-md-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="location" placeholder="Enter location name" value="" >
                            <span class="error-message" id="title-error"></span>
                             @error('location')
                                <small class="text-danger">{{ $message }}</small>
                             @enderror
