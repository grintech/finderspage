            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               ...
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('pay.auth.reccurring.featured.save',['id' => $id]) }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="" id="payment-form">
                        @csrf
      ...
      if (plan_id) {
         ...
         paypal.Buttons({
            ...
            onApprove: function(data, actions) {
               ...
               $.ajax({
                  url: baseurl + '/paypal/featured_save' + planname,
                  method: 'POST',
                  headers: {
