		...
		<form action="<?php echo route('admin.admins') ?>">
			...
			<div class="dropdown-item">
				<div class="row">
					<div class="col-md-12">
						<div class="custom-control custom-radio custom-control-inline">
							<input type="radio" id="allRecords" name="status" value="" <?php echo (!isset($_GET['status']) || $_GET['status'] === '' || $_GET['status'] === null ? 'checked' : '') ?> class="custom-control-input">
							<label class="custom-control-label" for="allRecords">All</label>
						</div>
						<div class="custom-control custom-radio custom-control-inline">
