      ...
      <div class="card p-3">
         <div class="row">
            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               <h1 class="strip-heading">Job listings are charged $5. Your listing will expire after 30 days. If you renew it before the 30 days is up, your listing will stay up for another 30 days.</h1>
                        ...
                        <div class="row" id="new_css">
                           <div class="col-lg-12">
                              <div class='form-row'>
                                 ...
                                 <span class="showprice"> $5/Per listing </span>
                              </div>
                           </div>
                        </div>
