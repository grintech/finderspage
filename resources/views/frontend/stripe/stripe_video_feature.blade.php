            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               ...
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('stripe.feature_video') }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="{{$public_key}}" id="payment-form">
                        @csrf
                        <div class="row" id="new_css">
                           ...
                           <div class="col-lg-6">
                              <div class='form-row' title="10 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="1-month-55">First Month &nbsp;<span class="showprice">$55/mo</span></label>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class='form-row' title="20 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="3-month-166">Three Month's &nbsp;<span class="showprice">$166/mo</span></label>
                              </div>
                           </div>
                           <div class="col-lg-6">
                           ...
                           <div class="col-lg-6">
                              <div class='form-row' title="100 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="1-year-777">One Year &nbsp;<span class="showprice">$777/year</span></label>
                              </div>
                           </div>
                        </div>
