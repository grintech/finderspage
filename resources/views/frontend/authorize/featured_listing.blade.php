            ...
            <div class="col-md-6 mt-4 mt-md-0" id="sec_new">
               ...
               <div class="panel panel-default credit-card-box">
                  ...
                  <div class="panel-body">
                     ...
                     @endif
                     <form role="form" action="{{ route('pay.auth.reccurring.save',['id' => $id]) }}" method="post" class="require-validation strip-form" data-cc-on-file="false" data-stripe-publishable-key="" id="payment-form">
                        @csrf
                        <div class="row" id="new_css">
                           ...
                           <div class="col-lg-6">
                              <div class='form-row align-start' title="10 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="1-month-55">One Month &nbsp;<span class="showprice"> ${{$plan_month->price}}/One Month</span></label>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class='form-row align-start' title="20 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="3-month-166">Three Months &nbsp;<span class="showprice">${{$plan_3month->price}}/Three Months</span></label>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class='form-row align-start' title="40 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="6-month-333">Six Months &nbsp;<span class="showprice">${{$plan_6month->price}}/Six Months</span></label>
                              </div>
                           </div>
                           <div class="col-lg-6">
                              <div class='form-row align-start' title="100 posts feature on the homepage" data-toggle="tooltip" data-placement="top">
                                 ...
                                 <label for="1-year-777">One Year &nbsp;<span class="showprice">${{$plan_year->price}}/One Year</span></label>
