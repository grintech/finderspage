      ...
      <div class="container">
        <div class="row justify-content-end">
          <div class="col-lg-12">
            ...
            <h3 class="d-inline"><b>Your Community Ads</b></h3>
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr class="status-list">
                          <td>@if($blogs->status == 1)<button class="btn-success">Published</button>@else<button class="btn-danger">Unpublished</button>@endif</td>
                      ...
                      @if($userData->subscribedPlan != '7-day-14' && $userData->subscribedPlan != '1-month-55' && !empty($userData->subscribedPlan ))
                        ...
                        @if($currentDateTime <= $nextTenDays)
                          <a href="{{route('our_community_edit',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit" ></i></a> 
                        @else
                          <a href="{{route('our_community_edit',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" >
        ...
        var link = $(this).attr("delete-link");
         Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
				      'Deleted!',
				      'Your Community listing has been deleted.',
				      'success'
				    )
            }
        });
