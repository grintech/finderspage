...
<head>
	...
	<link rel="stylesheet" href="<?php echo asset('assets/css/argon.css?v=1.2.0') ?>" type="text/css">
...
<body class="bg-default">
	...
	<script src="<?php echo url('assets/js/argon.js?v=kjfhsjkdfghsjkdf') ?>"></script>

	<script src="<?php echo url('assets/js/custom.js?v=hfksjdfhjks') ?>"></script>
