      ...
      <div class="container">
        <div class="row justify-content-end">
          <div class="col-lg-12">
            ...
            <h3 class="d-inline"><b>Your Service Ads</b></h3>
            <a class="btn profile-button float-right mb-2" href="{{route('add_services')}}">Add</a>
                          ...
                          <?php 
                           ...
                           @if($userData->subscribedPlan != '7-day-14' && $userData->subscribedPlan != '1-month-55' && !empty($userData->subscribedPlan ))
                              @if($currentDateTime <= $nextTenDays)
                                <a href="{{route('edit_services',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit"><i class="far fa-edit" ></i></a> 
                              @else
                                <a href="{{route('edit_services',$blogs->slug)}}" class="btn btn-warning" data-toggle="tooltip" data-placement="top" title="Edit" >
                            ...
                            @endif
                            <!-- <a data-toggle="tooltip" data-placement="top" title="$3 to bump this listing" href="{{route('pay.auth',General::encrypt($blogs->id))}}" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Bump">Bump</i></a> -->
        ...
        var link = $(this).attr("delete-link");
         Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Swal.fire(
				      'Deleted!',
				      'Your Service listing has been deleted.',
				      'success'
				    )
            }
        });
