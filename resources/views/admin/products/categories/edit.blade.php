								...
								<div class="col-lg-12">
									<div class="form-group">
										...
										<select class="form-control" name="parent_id" required>
							      			...
							      			<option value="<?php echo $c['id'] ?>" <?php if(isset($category->parent_id) && $category->parent_id == $c['id']) echo 'selected'; ?>><?php echo $c['title'] ?></option>
							      			<?php endforeach; ?>
							    		</select>
										@error('category')
											<small id="parent_id-error" class="text-danger">{{ $message }}</small>
										@enderror
									</div>
									<div class="form-group">
