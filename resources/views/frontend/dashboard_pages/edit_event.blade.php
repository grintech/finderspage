...
@section('content')
 ...
 <div class="container-fluid px-5">
 				<form method="post" action="<?php echo route('update_event',$blog->id); ?>" class="form-validation" enctype="multipart/form-data" id="eventFormEdit">
 					{{ @csrf_field() }}
                    <!-- Page Heading -->
                    ...
                    <div class="row bg-white border-radius mt-5 p-3">
                      <div class="col-md-4 mb-4 social-area">
                            <input type="radio"  name="post_type" value="Bump Post" {{ $blog->post_type === 'Bump Post' ? 'checked' : '' }}>
