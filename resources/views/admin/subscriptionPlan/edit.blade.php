...
<div class="container-fluid px-5">
 				<form method="post" action="{{route('sub-plan.update',$plan->id)}}" enctype="multipart/form-data" id="blog">
 					{{ @csrf_field() }}
                    <!-- Page Heading -->
                    ...
                    <div class="row bg-white border-radius pb-4 p-3">
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="price" placeholder="Enter Price" value="{{$plan->price}}" >
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="feature_listing" placeholder="Enter feature listing" value="{{$plan->feature_listing}}" >
                            <span class="error-message" id="title-error"></span>
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="number" class="form-control" name="slideshow" placeholder="Enter Price" value="{{$plan->slideshow}}" >
                            <span class="error-message" id="title-error"></span>
                             @error('slideshow')
                                <small class="text-danger">{{ $message }}</small>
                             @enderror
