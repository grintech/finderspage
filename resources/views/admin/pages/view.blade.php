			...
			<div class="header-body">
				<div class="row align-items-center py-4">
					...
					<div class="col-lg-6 col-5 text-right">
						<a href="<?php echo route('admin.pages') ?>" class="btn btn-neutral"><i class="fa fa-angle-left"></i> Back</a>
						<a href="javascript:;" class="btn btn-neutral"><i class="fa fa-eye"></i> View Page</a>
