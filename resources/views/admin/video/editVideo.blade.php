  ...
  <div class="container">
    <div class="row jutify-content-center">
      <div class="col-lg-8 col-md-8 col-sm-6 mx-auto">
        <form method="post" action="{{route('video.update.admin',$video->id)}}" enctype="multipart/form-data">
          @csrf
          <span>
          ...
          <!-- <div class="accordion mt-3" id="location">
            <div class="card border-left-warning shadow showdata">
              ...
              <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#location">
                <div class="card-body pt-1">
                  <div class="location-field">
                    <input type="text" class="form-control" name="location" id="loc" placeholder="location" value="{{$video->location}}">
                  </div>
                </div>
              </div>
            </div>
