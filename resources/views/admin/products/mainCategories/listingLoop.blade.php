...
<tr>
	...
	<td class="text-right">
		<?php if(Permissions::hasPermission('main_categories', 'update') || Permissions::hasPermission('main_categories', 'delete')): ?>
			<div class="dropdown">
				<a class="btn btn-sm btn-icon-only text-warning" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<i class="fas fa-ellipsis-v"></i>
				</a>
				<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
					<?php if(Permissions::hasPermission('main_categories', 'update')): ?>
					<a class="dropdown-item" href="<?php echo route('admin.products.mainCategories.edit', ['id' => $row->id]) ?>">
					...
					<a 
						...
						href="javascript:;"
						data-link="<?php echo route('admin.products.mainCategories.delete', ['id' => $row->id]) ?>"
					>
