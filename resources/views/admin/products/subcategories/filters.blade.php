<div class="dropdown filter-dropdown">
	...
	<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
		<form action="<?php echo route('admin.products.subCategories') ?>" id="filters-form">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="form-group">
							...
							<select class="form-control" name="category[]" required id="category-finder" multiple>
			...
			<div class="dropdown-divider"></div>
			<a href="<?php echo route('admin.products.subCategories') ?>" class="btn btn-sm py-2 px-3 float-left">
				Reset All
			</a>
