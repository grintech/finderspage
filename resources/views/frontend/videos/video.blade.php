	                            	...
	                            	<!-- <a href="{{route('single.test.video', $vid->id)}}"> -->
		                                <div class="thumb-video-box">
									        <div class="thumbnail-container">
									        	<!-- <video accept="video/mp4,video/x-m4v,video/*" class="thumbnail-video" controls playsinline src="{{asset('video_short')}}/{{$vid->video}}" loop>
											...
											<video class="thumbnail-video" loop muted playsinline="playsinline" poster="https://www.finderspage.com/public/{{$vid->image}}">
												...
												<!-- <video preload="yes" loop width="100%" height="auto" src="{{asset('video_short')}}/{{$vid->video}}">
