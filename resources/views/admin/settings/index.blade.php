	...
	<div class="row">
								...
								<div class="col-md-12">
									<div class="form-group">
										...
										<div class="custom-control">
											...
											<label class="custom-control-label">2nd Factor Authentication</label>
										</div>
									</div>
								</div>
							</div>
		...
		<div class="col-xl-6 order-xl-1">
							...
							<div class="smtp-section <?php echo ($method != 'smtp' ? 'd-none' : '') ?>">
								...
								<div class="form-group">
									...
									<div class="input-group passwordGroup">
										<input type="password" class="form-control" placeholder="******" aria-label="Recipient's username with two button addons" aria-describedby="button-addon4" name="smtp_password" value="{{ (Settings::get('smtp_password')) }}">
			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.settings.social') ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
						<div class="pl-lg-4">
							<div class="form-group">
