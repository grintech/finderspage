...
<div class="container px-sm-5 px-4 pt-4">
		  <h1 class="mt-5 d-inline">Business page</h1>
		  <a  href="{{route('blog_post')}}" class="btn btn-warning float-right">Create new</a>
             ...
             <div class="col-lg-3 col-md-4 col-12 blog-box mb-4">   
    		    <div class="card">
    		       @if(isset($post->business_logo))
                    <img class="card-img-top" src="{{asset('business_img')}}/{{$post->business_logo}}" alt="img..." >
                   @else
                    <img  class="card-img-top" src="{{asset('images_blog_img/1688636936.jpg')}}" alt="img..." >
                   @endif
    				  <div class="card-body">
    				    <h5 class="card-title">{{$post->business_name}}</h5>
    				    <p class="card-title">
    				     <?php
        				...
        				<div class="row">
                            <div class="col-md-12 px-3">
        						<a href="{{route('business_page.front.single.listing',$post->slug)}}" class="btn btn-warning"><i class="fa fa-eye" aria-hidden="true"></i></a>
        				    	<!-- <a href="#" class="btn btn-warning"><i class="far fa-edit"></i></a>   -->
        						<a href="#" data-link="{{route('admin.business.delete',$post->id)}}" id="del_my_blog" class="btn btn-danger"><i class="fa fa-trash" aria-hidden="true"></i></a>
