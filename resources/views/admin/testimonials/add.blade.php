			...
			<div class="card">
				...
				<div class="card-header">
					<div class="row align-items-center">
						<div class="col-8">
							<h3 class="mb-0">Create New Testimonial Here.</h3>
						</div>
					</div>
				</div>
				<div class="card-body">
					<form method="post" action="<?php echo route('admin.testimonials.add') ?>" class="form-validation">
						<!--!! CSRF FIELD !!-->
						{{ @csrf_field() }}
							...
							<div class="row">
								<div class="col-lg-6">
									<div class="form-group">
										<label class="form-control-label" for="input-name">Customer Name</label>
								...
								<div class="col-lg-6">
									<div class="form-group">
										<label class="form-control-label" for="input-designation">Customer Designation</label>
									...
									<div class="form-group">
										<label class="form-control-label">Rating</label>
						                   <select 
						                   		...
						                   		name="rating"
						                   	>
					                           	<option value="1" data-content="<i class='fas fa-star'></i>"></option>
					                           	<option value="2" data-content="<i class='fas fa-star'></i><i class='fas fa-star'></i>">2</option>
					                           	<option value="3" data-content="<i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i>">3</option>
					                           	<option value="4" data-content="<i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i>">4</option>
					                           	<option value="5" data-content="<i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i><i class='fas fa-star'></i>">5</option>
						                  	</select>
										@error('rating')
										    <small class="text-danger">{{ $message }}</small>
										@enderror
