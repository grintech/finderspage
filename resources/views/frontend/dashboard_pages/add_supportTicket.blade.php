...
<div class="container px-sm-5 px-4 pb-4">
 				<form method="post" action="{{route('support.save')}}" enctype="multipart/form-data" >
 					{{ @csrf_field() }}
                    <!-- Page Heading -->
                    ...
                    <div class="row bg-white border-radius pb-4 p-3">
                        <div class="col-md-12 mb-4">
                            ...
                            <input type="text" class="form-control" name="ticket_title" placeholder="Enter post name" value="<?php echo old('title'); ?>">
                        ...
                        <div class="col-md-12 mb-4">
                            ...
                            <div id="summernote">
                                <textarea id="editor1" class="form-control" name="discription" placeholder="Write a text"><?php echo old('description'); ?></textarea>
                    ...
                    <div class="mt-2 text-center"><button class="btn profile-button addCategory" type="submit">Submit</button>
